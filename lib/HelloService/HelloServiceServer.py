...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'HelloService'):
...
impl_HelloService = HelloService(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['HelloService.say_hello_async'] = ['HelloService', 'say_hello']
async_check_methods['HelloService.say_hello_check'] = ['HelloService', 'say_hello']
sync_methods['HelloService.say_hello'] = True
